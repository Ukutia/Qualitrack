...
describe('importación desde Google Drive (HU09)', () => {
  ...
  it('no convierte un error del archivo en un error de conexión reintentable', async () => {
    drive.getFileMeta.mockResolvedValue(PDF());
    drive.downloadFile.mockRejectedValue(new Error('El archivo no está disponible'));
    ...
    expect(res.body.error).toContain('El archivo no está disponible');
